...
import static com.codingchili.core.Configuration.Strings.MAP_CHARACTERS;
import static com.codingchili.core.Configuration.Strings.MAP_ID;

/**
 * @author Robin Duda
 */
public class HazelCharacterDB implements AsyncCharacterStore {
    private AsyncMap<String, Map<String, PlayerCharacter>> characters;
